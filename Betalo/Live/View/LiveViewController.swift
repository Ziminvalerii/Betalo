...
class LiveViewController: BaseVC {
    ...
    private(set) lazy var searchView: SearchView = {
        ...
        searchView.searchBar.placeholder = "Live now!"
    ...
    private lazy var emptyLabel: UILabel = {
        ...
        label.text = "No live events found :("
        return label
    }()
    ...
    private func setupTableView() {
        ...
        tableView = EventsTableView(eventType: .live)
        ...
        //            .assign(to: \.viewModel, on: tableView)
            .store(in: &cancellables)
...
extension LiveViewController: SearchViewDelegate {
...
extension LiveViewController: DropDownViewDataSource, DropDownViewDelegate {
